...
const CATEGORY_DEFS = [
  ...
  { id: 'animals', label: 'Animals', kw: ['bunny', 'cat', 'bear', 'panda', 'penguin', 'elephant', 'frog', 'owl', 'dog', 'shiba', 'sheep', 'turtle', 'ladybug', 'bee', 'hen', 'chick', 'bird', 'mouse', 'octopus', 'puppy', 'monkey', 'otter', 'sloth', 'raccoon'] },
